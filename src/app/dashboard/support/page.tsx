          ...
          {loading && tickets.length === 0 ? (
            ...
            tickets.map(ticket => (
              <div 
                ...
                className={`p-4 rounded-xl border cursor-pointer transition-all ${activeTicket?.id === ticket.id ? 'bg-white/[0.05] border-white/20' : 'bg-[#050505] border-white/5 hover:border-white/10'}`}
              >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white/[0.02] border border-white/10 rounded-xl px-4 py-3 text-sm font-bold outline-none focus:border-red-600/50"
                  />
                </div>
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white/[0.02] border border-white/10 rounded-xl px-4 py-3 text-sm font-bold outline-none focus:border-red-600/50 resize-none"
                  />
                </div>
                <div className="pt-2">
                  <button 
                 ...
                 <div className="p-4 border-t border-white/5 bg-[#050505]">
                    <div className="flex gap-3">
                      ...
                      <button 
                        ...
                        className="w-12 h-12 shrink-0 bg-white/10 disabled:opacity-50 hover:bg-white/20 text-white rounded-xl transition-all flex items-center justify-center"
                      >
                        <Send size={16} />
                      </button>
                    </div>
