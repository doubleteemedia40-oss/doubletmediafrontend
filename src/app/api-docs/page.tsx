...
export default function ApiDocsPage() {
            ...
            <div className="lg:col-span-9 space-y-24">
              ...
              <section className="space-y-8">
                ...
                <div className="rounded-3xl border border-white/10 bg-[#050505] overflow-hidden shadow-2xl">
                  ...
                  <pre className="p-8 font-mono text-sm leading-relaxed overflow-x-auto text-white/70">
  ...
  "remains": 1000
              ...
              {/* Pro-User CTA */}
              <section className="relative p-10 sm:p-16 rounded-[3rem] bg-white text-black overflow-hidden group">
                <div className="absolute top-0 right-0 p-8 text-black opacity-10 transform translate-x-4 -rotate-12 group-hover:scale-110 transition-transform">
                   <Code size={180} />
                </div>
                <div className="relative z-10 max-w-xl">
                  ...
                  <Link href="/contact" className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-black text-white font-black uppercase tracking-widest text-[11px] group active:scale-95 transition-all">
