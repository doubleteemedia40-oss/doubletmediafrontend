...
export default function AdminLayout({
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="p-4 border-t border-foreground/5">
        <div className="flex items-center gap-3 px-4 py-3 bg-surface border border-foreground/10 rounded-xl mb-3">
          <ShieldAlert size={16} className="text-red-600 animate-pulse shrink-0" />
          <div className="min-w-0">
            <p className="text-[10px] font-black uppercase tracking-widest text-foreground/70">Access Level</p>
  ...
  return (
    <div className="flex h-screen bg-background text-foreground font-manrope overflow-hidden">
      ...
      {/* Main content */}
      <main className="flex-1 overflow-y-auto bg-surface-lighter relative min-w-0">
        <header className="h-16 sm:h-20 border-b border-foreground/5 flex items-center justify-between px-4 sm:px-8 bg-background/50 backdrop-blur-md sticky top-0 z-20">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-sm sm:text-base font-black uppercase tracking-wider text-foreground/80">{pageTitle}</h1>
            </div>
          </div>
