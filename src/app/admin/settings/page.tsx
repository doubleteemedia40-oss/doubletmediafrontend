  ...
  return (
    <div className="max-w-4xl space-y-6 sm:space-y-8 relative z-10 w-full">
      ...
      <motion.div 
        ...
        className="rounded-2xl sm:rounded-3xl bg-black border border-white/10 p-6 sm:p-8"
      >
        {loading ? (
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                >
                  <option value="false" className="bg-black text-white">Disabled (Normal Operations)</option>
                  <option value="true" className="bg-black text-red-500">Enabled (Purchasing Blocked)</option>
                </select>
              </div>
            ...
            <div className="pt-6 border-t border-white/10 flex justify-end">
               <button 
                 onClick={handleSave}
                 className="px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-xl text-sm font-black uppercase tracking-widest transition-all flex items-center gap-2"
               >
