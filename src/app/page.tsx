  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black flex flex-col">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-white dark:bg-black flex flex-col items-center justify-center min-h-[100dvh] pt-60 pb-16 sm:py-32 gap-8 sm:gap-20">
          ...
          <div className="container-custom relative z-20 flex flex-col items-center justify-center text-center w-full max-w-5xl mx-auto h-full flex-grow py-6 sm:py-12">
            ...
            <motion.h1 
              ...
              className="text-[2.5rem] sm:text-7xl md:text-8xl lg:text-[100px] xl:text-[110px] font-black tracking-[-0.04em] mb-4 sm:mb-6 leading-[0.95] text-black dark:text-white"
            >
               #1 Social Media
               <br />
               <span className="text-transparent bg-clip-text bg-gradient-to-r from-black dark:from-white via-black/80 dark:via-white/80 to-black/30 dark:to-white/30 tracking-tight">Marketplace.</span>
            </motion.h1>
             ...
             >
                <Link href="/register" className="group relative w-full sm:w-auto h-14 px-10 rounded-full bg-black dark:bg-white text-white dark:text-black font-black uppercase tracking-[0.1em] text-[11px] flex items-center justify-center gap-3 transition-transform active:scale-[0.98] overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-black dark:from-white via-gray-200 to-black dark:to-white opacity-0 group-hover:opacity-100 transition-opacity" />
                </Link>
                <Link href="#services" className="w-full sm:w-auto h-14 px-10 rounded-full bg-black/[0.03] dark:bg-white/[0.03] border border-white/[0.08] hover:bg-black/[0.08] dark:bg-white/[0.08] text-black dark:text-white font-bold uppercase tracking-[0.1em] text-[11px] flex items-center justify-center transition-all backdrop-blur-md">
                  View Services
                </Link>
             </motion.div>
             ...
             >
               <div className="relative w-full aspect-[16/9] sm:aspect-[21/8] bg-slate-50 dark:bg-[#050505]/40 backdrop-blur-3xl border border-white/[0.08] rounded-t-[1.5rem] sm:rounded-t-[2.5rem] shadow-[0_-20px_80px_rgba(220,38,38,0.05)] overflow-hidden flex items-end justify-center">
                 {/* Top Window Bar */}
                 ...
                 <div className="w-full h-[calc(100%-2rem)] sm:h-[calc(100%-3rem)] flex items-end justify-center p-3 sm:p-8 gap-2 sm:gap-8 opacity-80">
                   {/* Card 1 */}
                   <div className="w-1/2 sm:w-1/3 h-full max-h-[100px] sm:max-h-[140px] bg-black/[0.02] dark:bg-white/[0.02] border border-white/[0.05] rounded-xl sm:rounded-2xl flex flex-col justify-end p-3 sm:p-5 relative overflow-hidden group hover:border-red-600/30 transition-colors">
                     <div className="absolute top-3 left-3 sm:top-5 sm:left-5 h-6 w-6 sm:h-8 sm:w-8 rounded-full bg-black/[0.05] dark:bg-white/[0.05] flex items-center justify-center text-black/60 dark:text-white/60"><BarChart3 size={12} className="sm:hidden" /><BarChart3 size={14} className="hidden sm:block" /></div>
                     <p className="text-[8px] sm:text-[10px] font-bold text-black/70 dark:text-white/70 uppercase tracking-wider mb-0.5 sm:mb-1">Followers</p>
                     <p className="text-lg sm:text-2xl font-black text-black dark:text-white">+14,029</p>
                   ...
                   <div className="w-1/2 sm:w-1/3 h-full max-h-[130px] sm:max-h-[190px] bg-red-600/10 border border-red-600/20 rounded-xl sm:rounded-2xl flex flex-col justify-end p-3 sm:p-5 relative overflow-hidden shadow-[0_0_30px_rgba(220,38,38,0.15)] transform -translate-y-2 sm:-translate-y-4">
                     ...
                     <p className="text-xl sm:text-3xl font-black text-black dark:text-white">402</p>
                     <p className="text-[8px] sm:text-[10px] font-bold text-black/70 dark:text-white/70 mt-1 sm:mt-2">Delivering currently</p>
                   </div>
                   {/* Card 3 */}
                   <div className="w-1/3 h-full max-h-[140px] bg-black/[0.02] dark:bg-white/[0.02] border border-white/[0.05] rounded-xl sm:rounded-2xl flex flex-col justify-end p-3 sm:p-5 relative overflow-hidden group hover:border-red-600/30 transition-colors hidden sm:flex">
                     <div className="absolute top-5 left-5 h-8 w-8 rounded-full bg-black/[0.05] dark:bg-white/[0.05] flex items-center justify-center text-black/60 dark:text-white/60"><Wallet size={14} /></div>
                     <p className="text-[10px] font-bold text-black/70 dark:text-white/70 uppercase tracking-wider mb-1">Spent Today</p>
                     <p className="text-2xl font-black text-black dark:text-white">₦84,500</p>
                     <p className="text-[10px] font-bold text-black/60 dark:text-white/60 mt-2">API Balance</p>
                   </div>
                 </div>
        ...
        <section className="w-full relative z-10 border-y border-white/[0.06]">
          <div className="w-full h-24 sm:h-32 md:h-40 xl:h-48 relative overflow-hidden bg-white dark:bg-black">
            {/* Background glow */}
            ...
            <div className="absolute top-[15%] sm:top-[18%] left-0 w-full flex whitespace-nowrap animate-marquee">
              {[...Array(2)].map((_, i) => (
                <span key={i} className="flex items-center gap-4 sm:gap-6 mr-4 sm:mr-6 text-[11px] sm:text-xs md:text-sm font-black uppercase tracking-[0.25em] text-black/30 dark:text-white/30">
                ...
                <div
                  ...
                  className={`px-4 sm:px-6 py-2 sm:py-2.5 rounded-full backdrop-blur-xl text-[10px] sm:text-xs font-black uppercase tracking-[0.15em] border shadow-lg
                    ${pill.accent
                      ...
                      : 'bg-black/[0.04] dark:bg-white/[0.04] border-white/[0.08] text-black/90 dark:text-white/90'
                    }`}
                >
                  {pill.label}
                </div>
          ...
          <div className="container-custom">
            <div className="mb-16 sm:mb-24 flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div className="max-w-xl">
                ...
                <p className="text-black/70 dark:text-white/70 font-medium leading-relaxed">
              ...
              <Link href="/register" className="text-[10px] font-black uppercase tracking-[0.3em] text-red-600 hover:text-black dark:text-white flex items-center gap-2 group transition-colors whitespace-nowrap">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                return (
                  <div key={i} className="p-8 sm:p-10 rounded-3xl bg-slate-100 dark:bg-[#080808] border border-black/5 dark:border-white/5 group hover:border-red-600/30 transition-all duration-500 relative overflow-hidden flex flex-col h-full">
                     ...
                     <p className="text-sm text-black/70 dark:text-white/70 font-medium leading-relaxed mb-6 flex-grow">{item.desc}</p>
